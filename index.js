...
const getSchemaObject = (definitions, typeName, nameRegEx, metadata) => 
	...
	.map(d => {
		...
		return { type: objectType, name: name, metadata: metadat, genericType: type, blockProps: getBlockProperties(d.block, baseObj, metadata), inherits: superClass, implements: interface  };
	}));
